...
const QuickAction = ({ iconName, iconColor, bg, label, onPress }: any) => (
  ...
  >
    ...
    <Text className="text-[11px] text-center text-gray-600 font-semibold w-14">
      {label}
    </Text>
  </TouchableOpacity>
);
    ...
    <SafeAreaView className="flex-1 bg-[#F8FAFC]" edges={["top"]}>
      ...
      >
          ...
          <View className="flex-row items-start">
            ...
            <View className="flex-1">
              ...
              <Text className="text-sm text-gray-600 mt-1">
                ...
                generate GST compliant invoices or estimates for your clients.
              </Text>
            </View>
          </View>
        </View>
        ...
        <View className="px-5 py-6">
          <Text className="text-sm font-bold text-gray-600 uppercase tracking-wide mb-4">
            Quick Actions
          </Text>
