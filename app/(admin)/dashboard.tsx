...
export default function AdminDashboardScreen() {
  ...
  const ActionButton = ({ icon, label, bg, color, onPress }: any) => (
    <TouchableOpacity
      onPress={onPress}
      style={{ alignItems: "center", width: "22%", marginBottom: 16 }}
    >
      <View
        style={{
          width: 64,
      ...
      {avatar ? (
        ...
        <View
          style={{
            ...
            height: 40,
            borderRadius: 20,
            backgroundColor: COLORS.cardGreenLight,
            alignItems: "center",
            justifyContent: "center",
            marginRight: 12,
          }}
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.white }}>
      ...
      >
        ...
        >
          ...
          <View
            style={{
              backgroundColor: COLORS.SystemGreenBg,
            ...
            >
              <View
                style={{
                  ...
                  height: 36,
                  borderRadius: 18,
                  backgroundColor: COLORS.cardBlueLight,
                  alignItems: "center",
                  justifyContent: "center",
                  marginRight: 12,
                }}
            ...
            >
              <View
                style={{
                  ...
                  height: 36,
                  borderRadius: 18,
                  backgroundColor: COLORS.cardOrangeLight,
                  alignItems: "center",
                  justifyContent: "center",
                  marginRight: 12,
                }}
              >
                <Ionicons
                  name="clipboard"
                  size={18}
                  color={COLORS.cardOrangeOutline}
                />
              </View>
              <Text
                style={{
            ...
            >
              <View
                style={{
                  width: "40%",
                  height: "100%",
                  backgroundColor: COLORS.cardOrangeOutline,
                }}
              />
            </View>
          </View>
